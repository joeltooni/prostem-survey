...
const PERSONAS = [
  ...
  { value: "admin",       icon: "🏫", title: "School Admin / Teacher",
    desc: "Working in a school that teaches STEM — administrator or educator", time: "~6 min · 8 questions" },
];
...
const PERSONA_COPY = {
  ...
  admin:       "Teachers and administrators are the gateway. No innovation reaches students without your support. This survey helps us understand what is realistic in your school environment — so we build something that works with your realities, not against them, to support them.",
};
...
// currentSection: -1=Intro, 0…n-1=survey sections, n=Conclusion
...
export default function SurveyForm() {
  ...
  // Try to advance to next section — validate first
  const handleNext = () => {
  ...
  // ── SHARED TAB BAR (used on all screens) ──
    ...
    <div className="tabs-bar">
      <div className="tabs-inner">
        {allTabs.map((tab) => {
          ...
          const tabNum   = tab.id === -1 ? "✦" : `0${tab.id + 1}`;
          ...
          <div className="intro-card">
            ...
            <div className="stem-explainer">
              ...
              <p className="stem-explainer-body">
                <strong>STEM</strong> stands for <strong>S</strong>cience, <strong>T</strong>echnology, <strong>E</strong>ngineering, and <strong>M</strong>athematics — the subjects behind almost every invention, solution, and system in the modern world. If you study any of the subjects below, you are already in the STEM world:
              </p>
            ...
            {/* ── PERSONA COPY (shown once persona is selected) ── */}
            {formData.persona && (
  ...
  return (
    <div className="survey-wrapper">
      ...
      {/* Validation banner — shows only after a failed attempt */}
      {totalErrors > 0 && (
